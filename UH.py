...
def dataframe():
    ...
    for i in range(0,len(rawop)):
        ...
        opdata = {
            'CALL OI': calloi, 'CALL CHNG OI': callcoi, 'CALL LTP': cltp,'CVOL':cvol,'C-IV': civ,'STRIKE PRICE': stp,
           
            'PUT OI': putoi, 'PUT CHNG OI': putcoi, 'PUT LTP': pltp,'PVOL':pvol,'P-IV': piv,'LIV' : live,
        }
