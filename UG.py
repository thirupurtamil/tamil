...
from nselib import derivatives as de

f = nselib.trading_holiday_calendar()
c = cm.india_vix_data(period='1M')
d = de.future_price_volume_data(symbol='NIFTY', instrument='FUTIDX',period='1D')
